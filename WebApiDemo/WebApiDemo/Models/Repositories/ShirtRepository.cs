namespace WebApiDemo.Models.Repositories
{
    public static class ShirtRepository
    {
        ...
        {
            new Shirt { ShirtId = 1, Brand = "MyBrand", Color = "Blue", Gender = "Men", Price = 69, Size = 10},
            new Shirt { ShirtId = 2, Brand = "YourBrand", Color = "Red", Gender = "Men", Price = 420, Size = 12},
            new Shirt { ShirtId = 3, Brand = "My_Brand", Color = "Green", Gender = "Women", Price = 13, Size = 8},
            new Shirt { ShirtId = 4, Brand = "Your_Brand", Color = "Yellow", Gender = "Women", Price = 70, Size = 9},
        };
